...
const DashboardLayout = () => {
  return (
    <div>
      ...
      {/* <div class='flex flex-col sm-hidden w-64 h-screen px-4 py-8 bg-white border-r dark:bg-gray-900 dark:border-gray-700'>
        ...
        <div class='flex flex-col items-center mt-6 -mx-2'>
          <img
            ...
            alt='avatar'
          />
          <h4 class='mx-2 mt-2 font-medium text-gray-800 dark:text-white'>
            John Doe
          </h4>
          <p class='mx-2 mt-1 text-sm font-medium text-gray-600 dark:text-white'>
            john@example.com
          </p>
        </div>
