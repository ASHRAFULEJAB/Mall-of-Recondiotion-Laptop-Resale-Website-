    ...
    <div>
      ...
      <div className='drawer drawer-mobile'>
        ...
        <div className='drawer-side '>
          ...
          <div className='flex flex-col justify-between flex-1  lg:bg-gray-800 text-white p-12'>
            <nav>
              {!isAdmin && !isSeller && (
                <>
                  <Link
          ...
          {/* <ul className='menu p-4 w-80 bg-gray-900 text-white font-bold'>
            <li>
      ...
      {/* <div className='flex flex-col sm-hidden w-64 h-screen px-4 py-8 bg-white border-r dark:bg-gray-900 dark:border-gray-700'>
        ...
        <div className='flex flex-col items-center mt-6 -mx-2'>
          ...
          <p className='mx-2 mt-1 text-sm font-medium text-gray-600 dark:text-white'>
            john@example.com
          </p>
        </div>
