...
const Header = () => {
  ...
  return (
    <div className="w-full fixed z-20">
      <div
        className={`px-2 md:px-16 py-3 flex flex-row items-center transition duration-500 ${
          showBackground ? "bg-zinc-900 bg-opacity-90" : ""
        }`}
      >
        <div className="px-4 lg:py-5  sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
          <div className="relative flex items-center justify-between ">
            ...
            >
              ...
              <span className="lg:ml-2 lg:text-xl font-bold tracking-wide text-gray-100 uppercase">
            ...
            <ul className="flex items-center hidden space-x-8 lg:flex lg:ml-40">
              {user?.uid ? (
                <>
                  <li onClick={handleLogout}>
                    <Link
                      ...
                      duration-200 rounded shadow-md bg-purple-700
                       hover:bg-purple-800 focus:shadow-outline focus:outline-none"
                      aria-label="Sign up"
                      title="Sign up"
                    >
                      Logout
                  ...
                  <li>
                    <Link
                      ...
                      className="inline-flex items-center justify-center h-12
                       ...
                       rounded shadow-md bg-purple-700 hover:bg-purple-800 focus:shadow-outline
                        focus:outline-none"
                      aria-label="Sign up"
                      title="Sign up"
                    >
            ...
            <div className="lg:hidden">
              ...
              <label htmlFor="navbar-toogle" className="drawer-button ">
                <AdjustmentsHorizontalIcon className="text-teal-500" />
              </label>
              {isMenuOpen && (
