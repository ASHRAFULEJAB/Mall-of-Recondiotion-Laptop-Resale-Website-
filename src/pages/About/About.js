  ...
  return (
    <section class="bg-gray-900 dark:bg-gray-100">
      ...
      <div class="container px-6 py-10 mx-auto">
        <h1 class="text-3xl font-semibold text-gray-100 capitalize lg:text-4xl dark:text-gray-800">
          explore More <br /> About Mall Of Recondition Laptops
        </h1>
        ...
        <div class="mt-8 xl:mt-12 lg:flex lg:items-center">
          <div class="grid w-full grid-cols-1 gap-8 lg:w-1/2 xl:gap-16 md:grid-cols-2">
            <div class="space-y-3">
              <span class="inline-block p-3 text-blue-500 bg-blue-100 rounded-xl dark:text-gray-800 dark:bg-blue-500">
                <svg
              ...
              <h1 class="text-2xl font-semibold text-gray-100 capitalize dark:text-gray-800">
                New Product
              </h1>
            ...
            <div class="space-y-3">
              ...
              <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-gray-800">
                elegant Resale Product
              </h1>
